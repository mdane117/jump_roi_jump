...
public class TacoPickupGenerator : MonoBehaviour
{
    [SerializeField] LevelGenerator levelGenerator;
    [Header("Taco Pickup")]
    [SerializeField] private GameObject tacoPickupPrefab;
    ...
    void Start()
    {
        ...
        for (int i = 0; i < pickupCount; i++)
        {
            ...
            Instantiate(tacoPickupPrefab, spawnPosition, Quaternion.identity);
        }
    }
}
